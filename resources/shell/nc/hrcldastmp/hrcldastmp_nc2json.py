#coding=utf-8
# Filename: hrcldastmp_nc2json.py
...
inputFilePath = sys.argv[1] # /space/data2/tmp/HRCLDAS-TMP/Z_NAFP_C_BABJ_20180615002906_P_HRCLDAS_RT_CHN_0P01_HOR-TMP-2018061500.nc
...
def ncToJson():
	...
	# 获取基础数据
	xCount = nc.dimensions["LON"].size
	yCount = nc.dimensions["LAT"].size
	lats = nc.variables["LAT"]
	lons = nc.variables["LON"]
	tair2D = nc.variables["TAIR"][:]
	...
	for idx in range(0, pntNums):
		data.append(abs(round(bjInterpData[idx], 4)))
	...
	outputFileRootPath = "/space/data2/tmp/json/HRCLDAS-TMP/"
