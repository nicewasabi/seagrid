...
def rmAccuToMicaps4():
	...
	for index in range(1, len(timelimits)):
		timeStart = time.time()
		tmlimit1 = timelimits[index - 1] # 000
		tmlimit2 = timelimits[index] # 003
		fileName1 = datetime + "." + tmlimit1 # 17072608.000
		fileName2 = datetime + "." + tmlimit2 # 17072608.003
