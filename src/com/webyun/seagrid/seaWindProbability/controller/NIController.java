 ...
 * @Project: seaGrid
 * @Title: NIController
 * @Description: 北印度洋数据展示控制器
 * @Author: songwj
 * @Date: 2017-12-5 下午8:36:20
 * @Company: webyun
...
public class NIController {
	...
	private Logger log = Logger.getLogger(NIController.class);
	...
	public Boolean validImage(String datetime, String timelimit, String windType, HttpServletResponse response) {
		try {
			// 获取对应日期时间的图片所在路径
			String path = WindProbabilityUtil.getNIWindImagePath(datetime, timelimit, windType);
