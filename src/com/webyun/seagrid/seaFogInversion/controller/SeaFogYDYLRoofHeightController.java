 ...
 */
@Controller
@RequestMapping("/seaFogInversion/ydylRoofHeight")
public class SeaFogYDYLRoofHeightController {
	private Logger log = Logger.getLogger(SeaFogYDYLRoofHeightController.class);

	@RequestMapping("/main.do")
	public String toMain() {
		return "/seaFogInversion/seaFogInversionYDYLRoofHeight";
	}
