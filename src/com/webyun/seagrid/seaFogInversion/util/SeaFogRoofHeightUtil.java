...
public class SeaFogRoofHeightUtil {

	private static Logger log = Logger.getLogger(SeaFogRoofHeightUtil.class);

	private static final String FYSeafogREGC05H_ROOTPATH = FileConfigUtil.getProperty("image.FYSeafogREGC05H");

	private static final String FYSeafogNHEM15H_ROOT_PATH = FileConfigUtil.getProperty("image.FYSeafogNHEM15H");
	...
	public static String getImagePath(String datetime, String hour, String step, String minute) {
		...
		if (step != null && !step.equals("")) {
			switch (step) {
			case "05":
				dirPathPrefixString=FYSeafogREGC05H_ROOTPATH;
				break;
			case "15":
				dirPathPrefixString=FYSeafogNHEM15H_ROOT_PATH;
				break;
			default:
				break;
			}
