...
public class SeaFogYDYLUtil {

	private static Logger log = Logger.getLogger(SeaFogYDYLUtil.class);

	private static final String FYSeafogYDYL05_ROOTPATH = FileConfigUtil.getProperty("image.FYSeafogYDYL05");

	private static final String FYSeafogYDYL15_ROOT_PATH = FileConfigUtil.getProperty("image.FYSeafogYDYL15");
	...
	public static String getImagePath(String datetime, String hour, String step, String minute) {
		...
		if (step != null && !step.equals("")) {
			switch (step) {
			case "05":
				dirPathPrefixString=FYSeafogYDYL05_ROOTPATH;
				break;
			case "15":
				dirPathPrefixString=FYSeafogYDYL15_ROOT_PATH;
				break;
			default:
				break;
			}
